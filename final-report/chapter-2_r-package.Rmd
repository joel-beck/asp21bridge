...
$$
   ...
   Note that the term $\boldsymbol{Z^2}$ squares all elements of $\boldsymbol{Z}$ elementwise, $\boldsymbol{n}$ denotes the length of the vector $\boldsymbol{y}$. Furthermore, the function $colMeans$ returns a vector with the column means of a matrix, and the function $len$ simply returns the length of a vector.
