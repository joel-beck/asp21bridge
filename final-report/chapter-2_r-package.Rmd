...
Because the Full Conditional of $\boldsymbol{\gamma}$ cannot be assigned to a known type of distribution (see section \@ref(gamma)), the MCMC update for $\boldsymbol{\gamma}$ cannot be sampled directly but requires an Metropolis Hastings step.   
