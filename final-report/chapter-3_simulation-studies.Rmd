...
3. Exploring the effect of the **hyperparameters**.
    ...
    Section \@ref(hyper) analyzes the connection between variation of the input parameters `a_tau`, `b_tau`, `a_xi` and `b_xi` of the Inverse Gamma prior distribution of the variance parameters $\tau^2$ and $\xi^2$, as specified in chapter \@ref(math).
