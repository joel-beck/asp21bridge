...
```{r, hyper-pen-plots, echo=FALSE, fig.height=6, fig.width = 8, fig.cap="Heatmaps of $\\left \\Vert \\boldsymbol{\\beta} \\right \\Vert^2$ and  $\\left \\Vert \\boldsymbol{\\gamma} \\right \\Vert^2$ (excluding Intercepts)", fig.pos="t"}
