...
Throughout this rather theoretical exposition we will build connections from the derived equations to practical consequences that have to be considered in the code implementation discussed in sections \@ref(mcmc-ridge) and \@ref(mh) of chapter \@ref(package).
