...
The Markov Chain Monte Carlo samples for $\gamma$ based on the Metropolis - Hastings algorithm implemented in the `mcmc_ridge()` function are strongly correlated, even though the acceptance rate of the proposed values is reasonable:
