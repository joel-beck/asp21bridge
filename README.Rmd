...
$`\boldsymbol{\beta} = \begin{pmatrix} \beta_0 & \cdots & \beta_K \end{pmatrix}`$ 
and the *scale* parameter 
$`\boldsymbol{\gamma} = \begin{pmatrix} \gamma_0 & \cdots & \gamma_L \end{pmatrix}`$ 
are themselves normally distributed with prior mean $0$ and *hyperparameters* 
$\tau^2$ 
and 
$\xi^2$ 
