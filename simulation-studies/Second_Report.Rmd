...
Figures \@ref(fig:hyppar-tau-beta) and \@ref(fig:hyppar-tau-gamma) display the absolute deviation of the posterior mean estimates of the `mcmc_ridge()` sampler and the true parameters with the stated different values for `a_tau` and `b_tau`. 
...
In the lower panel, there is no clear effect of $\boldsymbol{\tau^2}$ and its parameters. 
