...
The sampler exhibits the best results for the scale estimates for $a_\xi \in \left\{2\right\}$, $b_\xi \in \left\{100\right\}$. Anyhow, due to the wide overall variation one must take this result with care.
